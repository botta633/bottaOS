...
x86_64-unknown-linux-gnu-gcc -ggdb -std=c99 -mcmodel=large -ffreestanding -fno-stack-protector -mno-red-zone -c ../kern/memory/heap.c
x86_64-unknown-linux-gnu-gcc -ggdb -std=c99 -mcmodel=large -ffreestanding -fno-stack-protector -mno-red-zone -c mem.c

x86_64-unknown-linux-gnu-ld -nostdlib -T link.lds -o kernel kernel.o  main.o trapa.o liba.o trap.o print.o debug.o mem.o heap.o math.o
